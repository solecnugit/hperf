...
class Analyzer:
    ...
    def __init__(self, test_dir_path: str, configs: dict, event_groups: EventGroup) -> None:
        """
        ...
        self.raw_data_path = os.path.join(test_dir_path, "perf_result")
    ...
    def get_aggregated_metrics(self, to_csv: bool = False) -> pd.DataFrame:
        ...
        if to_csv:
            results_path = os.path.join(self.test_dir_path, "results.csv")
