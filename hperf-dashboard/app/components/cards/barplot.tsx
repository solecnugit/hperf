...
export default function BarplotCard({ metricName, descriptionI18nKey, unit = "", metrics, barColorStyle = "hsl(var(--chart-2))" }: { metrics: TimeSeriesData[], metricName: string, descriptionI18nKey: string, unit?: string, barColorStyle?: string }) {
    ...
    return (
        <Card
            className="w-full h-full p-2 pt-2 select-none"
        >
