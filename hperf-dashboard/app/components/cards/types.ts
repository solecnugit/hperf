...
export type CardType = "lineplot" | "barplot" | "radialplot" | "hperf" | "cpuInfo" | "richLinePlot"
...
export interface RichLinePlotCardProps extends PlotCardProps {
    type: "richLinePlot"
...
export const availableCards = {
    "lineplot": numericFields.map((metricName) => ({
        type: "lineplot",
        metricName,
        avgI18nKey: `avg.${metricName}`,
        maxI18nKey: `max.${metricName}`,
        descriptionI18nKey: `description.${metricName}`,
